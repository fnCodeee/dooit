            ...
            >
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3 ">
                        ...
                        <h1 className="font-semibold text-3xl">Edit Categories</h1>
                    </div>
                ...
                <div className="flex gap-3">
                    <button className="text-lg border cursor-pointer hover:bg-red-500 border-red-500 px-6 py-3 rounded-xl">
                        Delete
                    </button>
